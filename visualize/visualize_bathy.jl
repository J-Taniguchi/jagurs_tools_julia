...
function visualize_bathy_and_line(bathy_path, line_path, out_dir; c=:topo, dpi=400, fig_type="svg", clip_lim=2000, chikei_lw=0.05, line_lw=0.1, out_fig_name=missing)
    grd = gmtread(bathy_path, grd=true)
    x = grd.x
    y = grd.y
    z = grd.z
